...
public class Information {
    ...
    public int getMediaQuadrante(int quadrante) {
        ...
        return switch (quadrante) {
            case 1 -> getMedia(0, 0, meioX, meioY);
            case 2 -> getMedia(meioX, 0, finalX, meioY);
            case 3 -> getMedia(0, meioY, meioX, finalY);
            case 4 -> getMedia(meioX, meioY, finalX, finalY);
            default -> 0;
        };
    }
    ...
    public int getMedianaQuadrante(int quadrante) {
        //avalia qual quadrante deve usar
        return switch (quadrante) {
            case 1 -> getMediana(0, 0, meioX, meioY);
            case 2 -> getMediana(meioX, 0, finalX, meioY);
            case 3 -> getMediana(0, meioY, meioX, finalY);
            case 4 -> getMediana(meioX, meioY, finalX, finalY);
            default -> 0;
        };
    }
    ...
    public int getModaQuadrante(int quadrante) {
        //avalia qual quadrante deve usar
        return switch (quadrante) {
            case 1 -> getModa(0, 0, meioX, meioY);
            case 2 -> getModa(meioX, 0, finalX, meioY);
            case 3 -> getModa(0, meioY, meioX, finalY);
            case 4 -> getModa(meioX, meioY, finalX, finalY);
            default -> 0;
        };
    }
    ...
    public int getVarianciaQuadrante(int quadrante) {
        //avalia qual quadrante deve usar
        return switch (quadrante) {
            case 1 -> getVariancia(0, 0, meioX, meioY);
            case 2 -> getVariancia(meioX, 0, finalX, meioY);
            case 3 -> getVariancia(0, meioY, meioX, finalY);
            case 4 -> getVariancia(meioX, meioY, finalX, finalY);
            default -> 0;
        };
    }
    ...
    public String getInfoMedia() {
        return "Média imagem completa: " + getMedia() + "\n" +
    ...
    public String getInfoMediana() {
        return "Mediana imagem completa: " + getMediana() + "\n" +
    ...
    public String getInfoModa() {
        return "Moda imagem completa: " + getModa() + "\n" +
    ...
    public String getInfoVariancia() {
        return "Variância imagem completa: " + getVariancia() + "\n" +
